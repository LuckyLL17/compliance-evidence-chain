...
func (value ChainEvent) Validate() error {
...
func (value ChainEvent) Key() string {
	return string(value.ID) + ":" + string(value.Status) + ":" + fmt.Sprint(value.Version)
}

func (value *ChainEvent) Prepare(now time.Time) {
...
func (value *ChainEvent) Advance(next Status, now time.Time) error {
...
func (value ChainEvent) View() EntityView {
	return EntityView{
		ID:        value.ID,
		Kind:      "chain-events",
		Name:      value.Name,
