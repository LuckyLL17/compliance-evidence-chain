...
func (value RetentionPolicy) Key() string {
	return string(value.ID) + ":" + string(value.Status) + ":" + fmt.Sprint(value.Version)
}

func (value *RetentionPolicy) Prepare(now time.Time) {
...
func (value *RetentionPolicy) Advance(next Status, now time.Time) error {
...
func (value RetentionPolicy) View() EntityView {
	return EntityView{
		ID:        value.ID,
